# analysis functions that the master.py and worker.py scripts need
# directly taken from HZZ jupyter notebook 
...
# For convenient naming and identification purposes, we define a dictionary which stores all the important names of the samples we want to pull from the database.
defs = {
    r'Data':{'dids':['data']},
...
# calculation for final histogram
